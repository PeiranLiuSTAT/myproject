...
You can download the compendium as a zip from from this URL: <https://github.com/PeiranLiuSTAT/myproject/archive/master.zip>

Or you can install this compendium as an R package, myproject, from GitHub with:
